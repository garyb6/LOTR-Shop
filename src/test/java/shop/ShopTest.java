...
public class ShopTest {
    ...
    @Before
    public void setUp() {
        shop = new Shop("Merry's Market");
        chainmail = new Chainmail("Bilbo's Mithril Shirt", "Value greater than the value of the whole Shire and everything in it",
        ...
        lembas = new Lembas("Quarter Lembas Loaf", "Increase Health by 25", ItemType.Healing, 5, 15,
                Cure.Health, 25);
